...
def __send_request(fields):
    ...
    try:
        ...
        __logger.error('Sending to thingspeak.com failed. Exception:{}'.format(e))
    else:
        __logger.info('Request sent to thingspeak.com. Response={}'.format(response))
